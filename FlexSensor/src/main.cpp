...
const float VCC = 4.85; // Measured voltage of Ardunio 5V line
...
Serial.println("Input from the serial port: " + String(flexV) + "Volts" );
 Serial.println("Resistance: " + String(flexR/1000) + " Kohm");
